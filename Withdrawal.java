...
public class Withdrawal extends JFrame implements ActionListener {
    ...
    JLabel text=new JLabel("Enter Amount for Withdrawal");
    ...
    withdrawa.setBounds(320, 455, 150, 30);
    withdrawa.setBackground(Color.WHITE);
...
//                    String query="INSERT INTO bank (pin, date, type, amount) VALUES ('"+pinnumber+"','"+date+"','"+deposit+"','"+number+"')";
                    String query="INSERT INTO bank (pin, date, type, amount) VALUES ('"+pinnumber+"','"+date+"','withdrawa','"+number+"')";
